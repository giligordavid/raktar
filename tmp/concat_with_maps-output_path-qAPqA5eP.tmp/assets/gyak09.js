  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el6,"value","Takarítás");
        dom.setAttribute(el6,"selected","");
        var el7 = dom.createTextNode("Takarítás");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Mosás");
        var el7 = dom.createTextNode("Mosás");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Főzés");
        var el7 = dom.createTextNode("Főzés");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Kutyasétáltatás");
        var el7 = dom.createTextNode("Kutyasétáltatás");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                ");
        dom.appendChild(el5, el6);
        ...
        dom.setAttribute(el4,"class","col-lg-2 control-label");
        var el5 = dom.createTextNode("Név és időpont");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        ...
        var el6 = dom.createTextNode("Add meg a neved és a dátumot!");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Elvégzendő feladatok!");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ...
        ["inline","link-to",["Új feladat felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[15,3],[15,94]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Feladat adatlapja");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h1");
        var el3 = dom.createTextNode("Feladatok kezelése");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("p");
        var el2 = dom.createTextNode("Feladatkezelő családok számára.");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el8 = dom.createTextNode("Feladatkezelő");
        dom.appendChild(el7, el8);
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n                ");
        dom.appendChild(el6, el7);
      ...
      statements: [
        ["inline","link-to",["Feladatok","errors.list"],["class","btn btn-default"],["loc",[null,[19,26],[19,87]]]],
        ["inline","link-to",["Új feladat felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[20,26],[20,117]]]],
...
if (runningTests) {
  ...
  require("gyak09/app")["default"].create({"name":"gyak09","version":"0.0.0+e1129627"});
}
