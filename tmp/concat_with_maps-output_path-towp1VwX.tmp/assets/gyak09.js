    ...
    var child0 = (function() {
      return {
        ...
        statements: [
          ...
          ["attribute","href",["concat",["/errors/delete/",["get","id",["loc",[null,[19,84],[19,86]]]]]]],
          ["inline","link-to",["Megtekint","errors.view"],["class","btn btn-info btn-sm"],["loc",[null,[20,16],[20,81]]]]
        ],
        locals: [],
        templates: []
      };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ...
        ["inline","link-to",["Úh hiba felvitele","errors.new"],["class","btn btn-default"],["loc",[null,[14,0],[14,68]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Blabla blabla blabla");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el9,"href","/logout");
        var el10 = dom.createTextNode("Kilépés");
        ...
        dom.setAttribute(el7,"class","navbar-text navbar-right");
        var el8 = dom.createTextNode("Üdv, öcskös!");
        dom.appendChild(el7, el8);
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n                    ");
        dom.appendChild(el6, el7);
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        var morphs = new Array(1);
        morphs[0] = dom.createUnsafeMorphAt(dom.childAt(fragment, [1, 1, 1, 3]),1,1);
        return morphs;
      },
      statements: [
        ["content","outlet",["loc",[null,[30,18],[30,30]]]]
      ],
      locals: [],
      templates: []
    };
