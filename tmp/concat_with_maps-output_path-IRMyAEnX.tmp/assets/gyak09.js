...
define('gyak09/pods/components/error-list/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ...
          ["inline","link-to",["Megtekint","errors.view",["get","this",["loc",[null,[19,52],[19,56]]]]],["class","btn btn-default btn-sm"],["loc",[null,[19,16],[19,89]]]],
          ["element","action",["deleteError",["get","this",["loc",[null,[20,47],[20,51]]]]],[],["loc",[null,[20,24],[20,53]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ["block","each",[["get","errors",["loc",[null,[12,16],[12,22]]]]],[],0,null,["loc",[null,[12,8],[23,17]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      statements: [
        ...
        ["attribute","value",["concat",[["get","data.helyszin",["loc",[null,[6,158],[6,171]]]]]]],
        ["content","errors.location",["loc",[null,[7,52],[7,71]]]],
        ["attribute","class",["concat",["form-group ",["subexpr","if",[["get","errors.description",["loc",[null,[10,36],[10,54]]]],"has-error"],[],["loc",[null,[10,31],[10,68]]]]]]],
        ["content","data.leiras",["loc",[null,[13,91],[13,106]]]],
        ["content","errors.description",["loc",[null,[15,52],[15,74]]]],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ...
        ["inline","link-to",["Új hiba felvitele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[15,3],[15,91]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Hiba megtekintése");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
...
define('gyak09/templates/application', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        var morphs = new Array(1);
        morphs[0] = dom.createUnsafeMorphAt(dom.childAt(fragment, [0, 1, 1, 3]),1,1);
        return morphs;
      },
      statements: [
