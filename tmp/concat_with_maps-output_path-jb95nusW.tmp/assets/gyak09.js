  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("dt");
        var el3 = dom.createTextNode("Dátum");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ...
        ["inline","link-to",["Vissza","errors.list"],["class","btn btn-default"],["loc",[null,[11,0],[11,58]]]]
      ],
      locals: [],
      templates: []
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el7 = dom.createTextNode("TV");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Laptop");
        var el7 = dom.createTextNode("Laptop");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Tablet");
        var el7 = dom.createTextNode("Tablet");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                    ");
        dom.appendChild(el5, el6);
        var el6 = dom.createElement("option");
        dom.setAttribute(el6,"value","Hifi");
        var el7 = dom.createTextNode("Hifi");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n                ");
        dom.appendChild(el5, el6);
        ...
        var el6 = dom.createTextNode("Add meg a termék leirását");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("Mégse");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n                ");
        dom.appendChild(el4, el5);
        ...
        var el6 = dom.createTextNode("Alkalmaz");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n            ");
        dom.appendChild(el4, el5);
      ...
      statements: [
        ...
        ["content","errors.location",["loc",[null,[12,52],[12,71]]]],
        ["attribute","class",["concat",["form-group ",["subexpr","if",[["get","errors.description",["loc",[null,[15,36],[15,54]]]],"has-error"],[],["loc",[null,[15,31],[15,68]]]]]]],
        ["content","data.leiras",["loc",[null,[18,91],[18,106]]]],
        ["content","errors.description",["loc",[null,[20,52],[20,74]]]],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Termékek!");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ...
        ["inline","log",[["get","model",["loc",[null,[12,6],[12,11]]]]],[],["loc",[null,[12,0],[12,13]]]],
        ["inline","error-list",[],["errors",["subexpr","@mut",[["get","model",["loc",[null,[13,20],[13,25]]]]],[],[]]],["loc",[null,[13,0],[13,27]]]],
        ["inline","link-to",["Új termék felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[15,3],[15,93]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h1");
        var el3 = dom.createTextNode("Új termék felvétele");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Termék adatlapja");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h1");
        var el3 = dom.createTextNode("Termékek kezelése");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("p");
        var el2 = dom.createTextNode("Raktár alkalmazás. Az alkalmazás segítségével termékeket vehetünk fel a listára. Megtekinthetjük az adatlapjukat. Módosithatjuk egy termék adatait, vagy akár ki is törölhetjük.");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        return el0;
      },
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el8 = dom.createTextNode("Termékkezelő alkalmazás");
        dom.appendChild(el7, el8);
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n                ");
        dom.appendChild(el6, el7);
      ...
      statements: [
        ["inline","link-to",["Termékek","errors.list"],["class","btn btn-default"],["loc",[null,[19,26],[19,86]]]],
        ["inline","link-to",["Új termék felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[20,26],[20,116]]]],
...
if (runningTests) {
  ...
  require("gyak09/app")["default"].create({"name":"gyak09","version":"0.0.0+8873bea2"});
}
