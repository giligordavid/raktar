  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("dt");
        var el3 = dom.createTextNode("Megnevezés");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("dt");
        var el3 = dom.createTextNode("Időpont, leírás");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("dt");
        var el3 = dom.createTextNode("Tárgy felvéve");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n  ");
        dom.appendChild(el1, el2);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Felvett tantárgyaim");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
      ...
      statements: [
        ...
        ["inline","link-to",["Új tárgy felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[15,3],[15,92]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("h1");
        var el3 = dom.createTextNode("Új tárgy felvétele");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el2 = dom.createTextNode("Tárgy adatlapja");
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el8 = dom.createTextNode("Tantárgykezelő");
        dom.appendChild(el7, el8);
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n                ");
        dom.appendChild(el6, el7);
      ...
      statements: [
        ["inline","link-to",["Tárgyaim","errors.list"],["class","btn btn-default"],["loc",[null,[19,26],[19,86]]]],
        ["inline","link-to",["Új tantárgy felvétele","errors.new"],["class","btn btn-default","id","newErrorButton"],["loc",[null,[20,26],[20,118]]]],
